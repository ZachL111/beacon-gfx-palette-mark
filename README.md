...
beacon-gfx-palette-mark is a Dart project for graphics. It focuses on this technical goal: Design a Dart verification harness for palette systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
