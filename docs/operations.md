...
`beacon-gfx-palette-mark` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for palette systems, covering security rule linting, safe and unsafe fixtures, and failure-oriented tests.
